...
export function useGoogleHandler() {
    ...
    const serverCheck = () => {
        return fetch("http://13.51.241.98/health-check", { method: 'GET' })
        .then(response => {
            if (response.ok) {
                return true;
            } else {
    ...
    const handleLogout = () => {
        ...
        .then(response => {
            if (response) {
                fetch('http://13.51.241.98/google/auth/logout', {
                    method: 'GET',
                    headers: {
    ...
    const handleLogin = () => {
        ...
        .then(response => {
            if (response) {
                fetch('http://13.51.241.98/google/auth/url', {
                    method: 'GET',
                    headers: {
                    'Content-Type': 'application/json',
                    }, 
        ...
        .then(response => {
            if (response) {
                return new Promise<boolean>((resolve, reject) => {
                    fetch('http://13.51.241.98/google/calendar/list', {
                            method: 'GET',
                            credentials: 'include',
                        })
                        .then(response => response.json())
    ...
    const getCalendarEvents = (calendarId:string) => {
        ...
        .then(response => {
            if (response) {
                return new Promise<boolean>((resolve, reject) => {
                    fetch('http://13.51.241.98/google/events/get', {
                            method: 'POST',
                            credentials: 'include',
        ...
        .then(response => {
            if (response) {
                return new Promise<void>((resolve, reject) => {
                    ...
                    fetch('http://13.51.241.98/google/events/insert', {
                        method: 'POST',
                        headers: {
                        'Content-Type': 'application/json',
                        },
            ...
            serverCheck()
                .then(response => {
                    if (response) {
                        ...
                        fetch('http://13.51.241.98/google/events/update', {
                            method: 'POST',
                            headers: {
                                'Content-Type': 'application/json',
                            },
    ...
    const isAuthenticatedUser = async (emailParam:string):Promise<boolean> => {
        return new Promise((resolve, reject) => {
            fetch('http://13.51.241.98/google/auth/email', {
                method: 'POST',
                headers: {
                    'Content-Type': 'application/json',
                },
